...
function MyStartUp({ id }) {
  ...
  useEffect(() => {
    const getMystartUp = async () => {
      const responseStartUp = await getRequest(`${hostUrl}/startUp/${id}`);
      ...
      <section className="breadcrumbs">
        <div className="container">
          <div className="d-block  align-items-center">
            <p>
              {" "}
              Notre Equipe examine les informations ci-dessous pour déterminer
              l'éligibilité à d'autres avantages et vous faire correspondre à
            ...
            <div class="col-lg-6">
              <div className="row d-flex justify-content-between align-content-center">
                <div className="col-10 mb-2">
                  ...
                  <span className="" style={{ fontSize: "15px" }}>
                    {" "}
                    Partagé avec les experts sollicités
                  </span>
                </div>
                <div className="col-2">
                  {" "}
              ...
              <div className="row">
                <div className="col-12">
                  <p style={{ fontSize: "14px" }}>{dataStartUp.description}</p>
                </div>
                <div className="col-12 d-block">
                  <p className="mb-3">
                    <InsertLinkIcon />
                    <a href={dataStartUp.siteWeb}> site officiel</a>
                  </p>
                  <p className="mb-3">
                    <LocationOnIcon />
                    Pays: {dataStartUp.pays}{" "}
                  </p>
                </div>
                <hr />
              </div>
              <div className="row d-flex justify-content-center">
                ...
                <div className="col-6 p-3">
                  ...
                  <span style={{ fontSize: "15px" }}>
                    {dataStartUp.phaseFinancement} / auto-financement
                  </span>
                </div>
                <div className="col-6 p-3">
                  <h6>Modèle métier</h6>
                  <span style={{ fontSize: "15px" }}> B2C</span>
                </div>
                <div className="col-6 p-3">
                  <h6>Secteur</h6>
                  <span style={{ fontSize: "15px" }}>
                    {" "}
                    Horizontal (Inter-secteurs d'activité )
                  </span>
                </div>
              </div>
            </div>
